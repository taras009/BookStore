...
import com.example.comp_admin.bookstore.data.BookDbHelper;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup FAB to open EditProductDetails
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, EditProductDetails.class);
        ...
        bookListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                // Create new intent to go to {@link EditProductDetails}
                Intent intent = new Intent(MainActivity.this, EditProductDetails.class);

                // Form the content URI that represents the specific book that was clicked on,
                // by appending the "id" (passed as input to this method) onto the
                // {@link BookEntry#CONTENT_URI}.
                // For example, the URI would be "content://com.example.comp_admin.bookstore/books/2"
    ...
    private void insertBook() {
        ...
        // and "Harry Potter" book attributes are the values.
        ...
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER, "Scholastic");
        values.put(BookEntry.COLUMN_SUPPLIER_PHONE, "(866) 233-1692");
    ...
    private void deleteAllBooks() {
        ...
        Log.v("MailActivity", rowsDeleted + " rows deleted from book database");
    }

...
public class EditProductDetails extends AppCompatActivity implements
    ...
    /**
     * EditText field to enter the book's supplier's name
     */
    ...
    private void saveBook() {
        ...
        String supplierString = mBookSupplierEditText.getText().toString().trim();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mBookHasChanged) {
                    NavUtils.navigateUpFromSameTask(EditProductDetails.this);
                    return true;
                }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int bookSupplierColumnIndex = cursor.getColumnIndex(BookEntry.COLUMN_BOOK_SUPPLIER);
            ...
            mBookSupplierEditText.setText(bookSupplier);
    ...
    public void decreaseQuantity(View view) {
        int currentValue;
        String stringValue = String.valueOf((mQuantityEditText).getText());
        if(TextUtils.isEmpty(stringValue)){
            Toast.makeText(this, "Please set a  quantity value", Toast.LENGTH_SHORT).show();
            return;
        }
        currentValue = Integer.parseInt(stringValue);
        currentValue -= 1;
        if (currentValue < 0) {
            Toast.makeText(this, "This is minimal value", Toast.LENGTH_SHORT).show();
        } else
            mQuantityEditText.setText(String.valueOf(currentValue));
    }
    ...
    public void callSupplier(View v) {
        ...
        // stored in u.
        Uri u = Uri.parse("tel:" + mSupplierNumberEditText.getText().toString());

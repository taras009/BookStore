package com.example.comp_admin.bookstore.data;
...
public class BookProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.comp_admin.bookstore/books" will map to the
        ...
        // For example, "content://com.example.comp_admin.bookstore/books/3" matches, but
        // "content://com.example.comp_admin.bookstore/books" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case BOOK_ID:
                ...
                // For an example URI such as "content://com.example.comp_admin.bookstore/books/3",
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // No need to check the book supplier and its number, any value is valid (including null).
